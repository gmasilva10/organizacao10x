...
export function DeletePlanModal({
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await fetch(`/api/services/plans/${planId}`, {
        method: 'DELETE',
      })
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2 text-sm text-muted-foreground">
            ...
            <ul className="list-disc list-inside space-y-1 ml-2">
              <li>Todos os dados do plano serão removidos</li>
              <li>Contratos ativos com este plano serão mantidos</li>
              <li>Esta ação é permanente</li>
              <li>Planos com contratos ativos não podem ser excluídos</li>
            </ul>
          </div>
        </div>
